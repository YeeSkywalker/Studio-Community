...
public class MapperTests {
    ...
    public void updateUser() {
        ...
        rows = userMapper.updatePassword(150, "hello world");
        System.out.println(rows);
    }
    ...
    public void testSelectMessage() {
        ...
        list = messageMapper.selectDM("111_112", 0, 20);
        for (Message dm : list) {
            System.out.println(dm);
        }

        int dmCount = messageMapper.selectDMCount("111_112");
        System.out.println(dmCount);

        int unreadCount = messageMapper.selectUnreadCount(131, "111_131");
